...
## Complete.cases
- `complete.cases()` is used to get rid of any observations/rows with at least one `NA` value.
```{r}
df <- data.frame(A=1:3, B=c(4,5,NA), C=7:9)
