...
- As a next step, I highly recommend learning `ggplot2`, an excellent plotting package.
- Some resources:
    - [Data visualization with `ggplot2`](http://r4ds.had.co.nz/data-visualisation.html)
