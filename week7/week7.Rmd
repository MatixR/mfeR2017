...
- Loops that can’t be easily vectorised because subsequent iterations depend on previous ones. Particularly nested loops.
...
- May nee to run `Sys.setenv("PKG_CXXFLAGS"="-std=c++11")` first.
```{r}
...
## Resources
- Rcpp for Seamless R and C++ Integration: [Main Rcpp page](http://www.rcpp.org/).
...
- [Extending R](https://www.crcpress.com/Extending-R/Chambers/p/book/9781498775717) book.
